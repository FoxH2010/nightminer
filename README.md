...
This project is started by Richard Moore, though it's just support Python 2. I revisited this project and made it Python 3. You can see the original repository [here](https://github.com/ricmoo/nightminer).  
